...
settings = MainSettings(p_num_channels=64, p_mono_stereo=1, p_address_size=4, p_ts_tick=0.1, p_bin_size=2000, p_bar_line=1)
...
"""
print execution_time(average_activity,(ts, settings))
